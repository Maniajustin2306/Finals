...
<div class="container m-5 mx-auto">
			...
			<table class="table table-striped table-responsive w-100 ">
				...
				<?php foreach ($recVieworders as $key => $value) : ?>
					<tr>
						...
						<td class=" align-middle"><input class="form-control text-center" type="number" name ="inputUpdate" id="inputUpdate" value="<?php echo $value['voquantity']; ?>" /></td>
	...
	<div class="row mt-5">
		<div class="col offset-2">
			<a href="list_order.php" class="btn btn-danger" name="btnAddMore" value="Edit Profile"/><i class="fas fa-arrow-left"></i>&nbsp;Back</a>
		</div>
	</div>
</div>
